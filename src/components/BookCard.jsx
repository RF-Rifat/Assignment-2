...
const BookCard = ({ cardData }) => {
  ...
  const { name, author, price } = cardData;
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 text-xs lg:text-sm">
            ...
            <button
              ...
              className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#1C4336]/[14%] py-1.5 text-[#1C4336] transition-all lg:py-1.5  ${
                color ? "bg-red-500" : "bg-[#1C4336]"
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
